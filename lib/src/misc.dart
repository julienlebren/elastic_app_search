...
enum Operation {
  ...
  apiLogsGet("logs/api"),
  apiLogsQuery("logs/api"),
  credentialsList("credentials"),
  credentialGet("credentials"),
  credentialCreate("credentials"),
  credentialUpdate("credentials"),
  credentialDelete("credentials"),
  logSettingsGet("log_settings"),
  logSettingsPut("log_settings"),
  logSettingsPatch("log_settings"),
  logSettingsDelete("log_settings"),
  adaptiveRelevanceSuggestionsList("adaptive_relevance/suggestions"),
  adaptiveRelevanceSuggestionsQuery("adaptive_relevance/suggestions"),
  adaptiveRelevanceSuggestionsUpdate("adaptive_relevance/suggestions"),
  adaptiveRelevanceSuggestionsByQueryList("adaptive_relevance/suggestions"),
  adaptiveRelevanceSuggestionsByQueryQuery("adaptive_relevance/suggestions"),
  adaptiveRelevanceSettingsGet("adaptive_relevance/settings"),
  adaptiveRelevanceSettingsUpdate("adaptive_relevance/settings"),
  adaptiveRelevanceRefresh("adaptive_relevance/update_process"),
  crawlerGet("crawler"),
  crawlerActiveCrawlRequestGet("crawler/crawl_requests/active"),
  crawlerActiveCrawlRequestCancel("crawler/crawl_requests/active/cancel"),
  crawlerCrawlRequestsList("crawler/crawl_requests"),
  crawlerCrawlRequestCreate("crawler/crawl_requests"),
  crawlerPartialCrawlRequestCreate("crawler/crawl_requests"),
  crawlerCrawlRequestGet("crawler/crawl_requests"),
  crawlerCrawlScheduleGet("crawler/crawl_schedule"),
  crawlerCrawlSchedulePut("crawler/crawl_schedule"),
  crawlerCrawlScheduleDelete("crawler/crawl_schedule"),
  crawlerProcessCrawlsList("crawler/process_crawls"),
  crawlerProcessCrawlGet("crawler/process_crawls"),
  crawlerProcessCrawlDeniedUrlsGet("crawler/process_crawls"),
  crawlerProcessCrawlCreate("crawler/process_crawls"),
  crawlerUserAgentGet("crawler/user_agent"),
  crawlerDomainsList("crawler/domains"),
  crawlerDomainCreate("crawler/domains"),
  crawlerDomainGet("crawler/domains"),
  crawlerDomainUpdate("crawler/domains"),
  crawlerDomainDelete("crawler/domains"),
  crawlerEntryPointCreate("crawler/domains"),
  crawlerEntryPointUpdate("crawler/domains"),
  crawlerEntryPointDelete("crawler/domains"),
  crawlerCrawlRuleCreate("crawler/domains"),
  crawlerCrawlRuleUpdate("crawler/domains"),
  crawlerCrawlRuleDelete("crawler/domains"),
  crawlerSitemapCreate("crawler/domains"),
  crawlerSitemapUpdate("crawler/domains"),
  crawlerSitemapDelete("crawler/domains"),
  crawlerDomainValidate("crawler/validate_url"),
  crawlerUrlValidate("crawler/validate_url"),
  crawlerUrlExtract("crawler/extract_url"),
  crawlerUrlTrace("crawler/trace_url"),
  click("click"),
